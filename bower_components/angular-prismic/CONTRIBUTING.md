#Contributing to angular-prismic

We'd love for you to contribute to our source code and to make angular-prismic even better than it is
...
* Search [GitHub](https://github.com/kennethlynne/angular-prismic/pulls) for an open or closed Pull Request
...
* With the exceptions listed below, we follow the rules contained in
  [Google's JavaScript Style Guide][js-style-guide]:
    ...
    * We **don't go crazy with type annotations** for private internal APIs unless it's an internal API
      that is used throughout angular-prismic. The best guidance is to do what makes the most sense.

## Git Commit Guidelines

We have very precise rules over how our git commit messages can be formatted.  This leads to **more
readable messages** that are easy to follow when looking through the **project history**.  But also,
we use the git commit messages to **generate the angular-prismic change log**.
...
[github]: https://github.com/kennethlynne/angular-prismic
[stackoverflow]: http://stackoverflow.com/questions/tagged/angular-prismic
